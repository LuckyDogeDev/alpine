...
perl -0777 -i -pe 's/safeT/t/g' contracts/Alpine.sol

# Virtualize functions
perl -0777 -i -pe 's/\) public allowed\(from\)/\) virtual public allowed\(from\)/g' contracts/Alpine.sol
perl -0777 -i -pe 's/\) public \{/\) virtual public \{ /g' contracts/Alpine.sol

# De-virtualize constructor
perl -0777 -i -pe 's/constructor\(IERC20 wethToken_\) virtual public/constructor\(IERC20 wethToken_\) public/g' contracts/Alpine.sol
