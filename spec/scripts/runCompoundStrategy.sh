...
--link CompoundStrategyHarness:token=DummyERC20A CompoundStrategyHarness:owner=Owner CompoundStrategyHarness:alpine=Receiver CompoundStrategyHarness:cToken=CErc20 CompoundStrategyHarness:compToken=DummyERC20B CErc20:underlying=DummyERC20A \
