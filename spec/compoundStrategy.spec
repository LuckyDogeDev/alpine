...
/*
At any given time, except during function execution, the CompoundStrategy contract doesn’t hold any tokens, all are invested in the Compound protocol or passed back to Alpine.
*/
...
/* Transfers excess tokens above balance. On a positive profit, Alpine’s balance increases and the return value is the profit above balance. On negative profit, the negative profit is returned. */
...
/* A withdraw operation increases the Alpine’s balance by the withdrawn amount */
...
/* The exit operation transfers all of the strategy's assets to Alpine */
