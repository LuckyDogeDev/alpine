/*
    ...
    This file is run with scripts/_runAlpine.sh
*/
 ...
 * checking if the the total assets within the Alpine and outside
 * the Alpine are preserved
 */
rule solvency(address token, address from, address to,
	...
	// link the strategy owner to the alpine
...
/*
 * For every token and every user, the total assets within the alpine and
 * outside the alpine should be preserved. If other users transfer to a
