...
interface AlchemyBenchMockInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "goldnugget", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "goldnugget", data: BytesLike): Result;
...
export class AlchemyBenchMock extends Contract {
  ...
  interface: AlchemyBenchMockInterface;
  ...
  functions: {
    ...
    goldnugget(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    goldnugget(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    goldnugget(overrides?: CallOverrides): Promise<PopulatedTransaction>;
