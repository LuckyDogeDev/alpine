...
interface LuckySwapFactoryMockInterface extends ethers.utils.Interface {
  functions: {
...
export class LuckySwapFactoryMock extends Contract {
  ...
  interface: LuckySwapFactoryMockInterface;
