...
interface GoldNuggetStrategyInterface extends ethers.utils.Interface {
  functions: {
...
export class GoldNuggetStrategy extends Contract {
  ...
  interface: GoldNuggetStrategyInterface;
