...
interface LuckySwapPairMockInterface extends ethers.utils.Interface {
  functions: {
...
export class LuckySwapPairMock extends Contract {
  ...
  interface: LuckySwapPairMockInterface;
